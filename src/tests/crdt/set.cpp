...
{
    crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local, crdt::hook_extract > set(allocator);
    decltype(set)::rebind_t< decltype(allocator), crdt::tag_delta, crdt::detail::metadata_tag_btree_local, crdt::hook_default > deltaset(allocator);
}

BOOST_AUTO_TEST_CASE(set_move)
{
    crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local > set(allocator);
    crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local > set2(std::move(set));
...
{
    crdt::set< T, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local, crdt::hook_extract > set(allocator);
...
{
    crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local, crdt::hook_extract > set1(allocator);
    crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local, crdt::hook_extract > set2(allocator);
...
BOOST_AUTO_TEST_CASE(set_sizeof)
{
    ...
    PRINT_SIZEOF(crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local, crdt::hook_default >);
    PRINT_SIZEOF(crdt::set< int, decltype(allocator), crdt::tag_state, crdt::detail::metadata_tag_btree_local, crdt::hook_extract >);
    PRINT_SIZEOF(crdt::set< int, decltype(allocator), crdt::tag_delta, crdt::detail::metadata_tag_btree_local >);
}