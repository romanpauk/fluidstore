...
public:
	...
	template< typename... Args > static void emplace(Args&&... args)
	{
		Container container;
	...
	static void erase_const_lvalue()
	{
	...
	static void erase_const_iterator()
	{
		Container container;
	...
	static void find_const_iterator()
	{
		const Container container;
		auto result = container.find(typename Container::value_type());
	...
	static void insert_const_lvalue()
	{
		typename Container::value_type value;
		Container container;
	...
	static void insert_hint_const_lvalue()
	{
		typename Container::value_type value;
		Container container;
	...
	static void insert_const_hint_const_lvalue()
	{
		typename Container::value_type value;
		Container container;
	...
	static void insert_hint_rvalue()
	{
		typename Container::value_type value;
		Container container;
	...
	static void insert_const_hint_rvalue()
	{
		typename Container::value_type value;
		Container container;
	...
	static void iterator_begin()
	{
		Container container;
		typename Container::iterator it = container.begin();
	}

	static void iterator_begin_const()
	{
		const Container container;
	...
	static void iterator_end()
	{
		Container container;
		typename Container::iterator it = container.end();
	}

	static void iterator_end_const()
	{
		const Container container;
		typename Container::const_iterator it = container.begin();
	}
	...
	static void lower_bound_iterator()
	{
		typename Container::value_type value;
		Container container;
	...
	static void lower_bound_const_iterator()
	{
		typename Container::value_type value;
		const Container container;
		auto result = container.lower_bound(static_cast< const Container::value_type& >(value));
