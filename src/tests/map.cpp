...
{
    crdt::map2< int, crdt::value_mv2< int >, decltype(allocator), crdt::tag_state > map(allocator);
...
{
    crdt::map2< int, crdt::value_mv2< int >, decltype(allocator), crdt::tag_state, crdt::hook_extract > map1(allocator);
    crdt::map2< int, crdt::value_mv2< int >, decltype(allocator), crdt::tag_state, crdt::hook_extract > map2(allocator);
...
{
    crdt::map2< int, crdt::map2< int, crdt::value_mv2< int > >, decltype(allocator), crdt::tag_state, crdt::hook_extract > map1(allocator);
    crdt::map2< int, crdt::map2< int, crdt::value_mv2< int > >, decltype(allocator), crdt::tag_state, crdt::hook_extract > map2(allocator);
...
BOOST_AUTO_TEST_CASE(map_set_merge)
{
    ...
    crdt::map2< int, crdt::set2< int >, decltype(allocator0), crdt::tag_state, crdt::hook_extract > map1(allocator0);
    crdt::map2< int, crdt::set2< int >, decltype(allocator1), crdt::tag_state, crdt::hook_extract > map2(allocator1);
...
BOOST_AUTO_TEST_CASE(map_sizeof)
{
    ...
    PRINT_SIZEOF(crdt::map2< int, crdt::value_mv2< int >, decltype(allocator) >);
    PRINT_SIZEOF(crdt::map2< int, crdt::value_mv2< int >, decltype(allocator), crdt::tag_state, crdt::hook_extract >);
    PRINT_SIZEOF(crdt::map2< int, crdt::value_mv2< int >, decltype(allocator), crdt::tag_delta >);
}
