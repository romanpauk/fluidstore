...
namespace crdt
{
    ...
    template < typename Key, typename Value, typename Allocator, typename ReplicaId, typename Counter, typename Container > class dot_kernel
    {
        ...
        template < typename Key, typename Allocator, typename Replica> friend class set_base;
        template < typename Key, typename Value, typename Allocator, typename Replica > friend class map_base;
