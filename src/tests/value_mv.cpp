...
{   
    crdt::value_mv2< int, decltype(allocator), crdt::tag_state, crdt::hook_extract > value(allocator);
...
{
    crdt::value_mv2< int, decltype(allocator), crdt::tag_state, crdt::hook_extract > value1(allocator);
    crdt::value_mv2< int, decltype(allocator), crdt::tag_state, crdt::hook_extract > value2(allocator);
...
BOOST_AUTO_TEST_CASE(value_mv_set)
{
    ...
    crdt::value_mv2< crdt::set2< int >, decltype(allocator0), crdt::tag_state, crdt::hook_extract > value0(allocator0);    
    crdt::value_mv2< crdt::set2< int >, decltype(allocator1), crdt::tag_state, crdt::hook_extract > value1(allocator1);
}
...
{
    PRINT_SIZEOF(crdt::value_mv2< int, decltype(allocator), crdt::tag_state, crdt::hook_default >);
    PRINT_SIZEOF(crdt::value_mv2< int, decltype(allocator), crdt::tag_state, crdt::hook_extract >);
    PRINT_SIZEOF(crdt::value_mv2< int, decltype(allocator), crdt::tag_delta >);
}
